...
"Define new basis"
renormalize_factor, map_dob, dob1, num_stat1 = trans_symm_basis()
...
np.savetxt('k_Eige_24.txt',Eige)
np.savetxt('size_k0.txt',size_k0)
